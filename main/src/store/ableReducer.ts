...
const ableReducer = (state = initialState, action: ACTIONTYPE): typeof initialState => {
    let trigger: string[] = [];
    let open: string[] = [];
    // const collapseMenu: boolean = false; -- will open side nav on click of any sub menu
    ...
    switch (action.type) {
        ...
        case actionTypes.COLLAPSE_TOGGLE:
            ...
            return {
                ...
                isOpen: open,
                isTrigger: trigger,
                // collapseMenu -- will open side nav on click of any sub menu
            };
