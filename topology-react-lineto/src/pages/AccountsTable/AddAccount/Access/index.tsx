    ...
    <div className="select-access">
      {showDailogBox && (
        <DailogBox
          ...
          show={showDailogBox}
          setShowDailogBox={setShowDailogBox}
        />
      )}
      <Row>
        <Col xl={12} md={12}>
        ...
        <Col xl={12} md={12}>
          ...
          <p className="steps-text">
            ...
            Either option will get you connected in just a few clicks! smfask
          </p>
        </Col>
      </Row>
              ...
              <Row className="access-keys-background">
                ...
                <Col xs={12}>
                  <CardGroup>
                    ...
                    <Card
                      className={
                        "custom-card disabled shadow-none" +
                    ...
                    >
                      <Card.Body>
                        ...
                        <div className="card-content">
                          <Card.Title className="card-title-style form-heading">
                            <h5> Let Cloud Fabric Connect the Account</h5>
                          </Card.Title>
                          <Card.Text className="card-text-style">
                ...
                {values.connectName === "cloudFabric" && (
                  <>
                    <h5 className="form-heading mt-2 mb-2">General</h5>
                    <Row>
