...
const Navigation = () => {
  ...
  const layoutType = useSelector((state: any) => state.able.layoutType);
  const rtlLayout = useSelector((state: any) => state.able.rtlLayout);
  const navFixedLayout = useSelector((state: any) => state.able.navFixedLayout);
  const headerFixedLayout = useSelector(
    (state: any) => state.able.headerFixedLayout
  );
  const boxLayout = useSelector((state: any) => state.able.boxLayout);
  ...
  const scroll = () => {
    if (navFixedLayout && !headerFixedLayout) {
      const el: any = document.querySelector(".pcoded-navbar.menupos-fixed");
      if (!el) return;
